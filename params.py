...
parser = argparse.ArgumentParser(description='Arguments for MTSR_FJSP')
# args for device
...
parser.add_argument('--op_per_module', type=float, default=0,
                    help='Number of operations per module, default 0, means the number equals m')
parser.add_argument('--op_per_worker_min', type=int, default=1,
                    help='Minimum number of compatible workers for each operation')
parser.add_argument('--op_per_worker_max', type=int, default=5,
                    help='Maximum number of compatible workers for each operation')
...
# args for or-tools
parser.add_argument('--max_solve_time', type=int, default=180, help='The maximum solving time of OR-Tools')
...
# args for env
parser.add_argument('--n_j', type=int, default=15, help='Number of modules of the instance')
parser.add_argument('--n_m', type=int, default=15, help='Number of workers of the instance')
parser.add_argument('--n_op', type=int, default=50, help='Number of operations of the instance')
parser.add_argument('--low', type=int, default=11, help='Lower Bound of processing time(PT)')
parser.add_argument('--high', type=int, default=19, help='Upper Bound of processing time')

# args for network
parser.add_argument('--fea_j_input_dim', type=int, default=10, help='Dimension of operation raw feature vectors')
parser.add_argument('--fea_m_input_dim', type=int, default=8, help='Dimension of worker raw feature vectors')
...
parser.add_argument('--num_heads_MAB', nargs='+', type=int, default=[4, 4],
                    help='Number of attention head of worker message attention block')
...
# args for test
parser.add_argument('--test_data', nargs='+', default=['15x15+mix'], help='List of data for testing')
...
parser.add_argument('--test_model', nargs='+', default=['10x10'], help='List of model for testing')
